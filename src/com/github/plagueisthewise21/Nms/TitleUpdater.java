...
public abstract class TitleUpdater {
	...
	public static void update(Player p, String newTitle){
		...
		case "v1_13":
			...
			Object enumContainer = "minecraft:chest";
			...
			Constructor<?> titleConstructor  = getNMSClass("PacketPlayOutOpenWindow").getConstructor(int.class, String.class, getNMSClass("IChatBaseComponent"));
